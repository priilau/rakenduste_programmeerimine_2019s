 ...
 * Task 2
 */
const reverseString = word => word.split("").reverse().join(""); // splitib stringi ära, keerab tagurpidi ja liidab stringi tagasi kokku
...
const generateRandomItemList = n => {
  ...
  for(let i = 0; i < n; i++){
    const item = {
      name: "midaiganes" + getRandomIntInclusive(0, 100),
 ...
 * Task 4
 */
const findMostExpensiveItem = items => null;

/**
 * Task 5
 */
const findCheapestItem = items => null;
